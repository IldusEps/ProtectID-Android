...
public class PythonActivity extends SDLActivity {
    ...
    public void restartNotify() {
        ...
        if (checkCurrentPermission(Manifest.permission.SYSTEM_ALERT_WINDOW)) {
...
/*public boolean Predict(){
    ...
    faceRecognizer.load("/storage/emulated/0/ProtectID/mymodel.xml");
    IntPointer label = new IntPointer(1);
    DoublePointer confidence = new DoublePointer(1);
    opencv_objdetect.CascadeClassifier face_cascade = new opencv_objdetect.CascadeClassifier(
            "/storage/emulated/0/ProtectID/lbpcascade_frontalface.xml");
